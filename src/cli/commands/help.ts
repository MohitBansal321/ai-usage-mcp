...
Notes:
  ...
  \`sync\` also downloads LiteLLM's public price list, at most once a day, to price
  Claude models released after the built-in table. It only fills models the table
  lacks, sends no data, and \`AI_USAGE_NO_PRICING_REFRESH=1\` disables it (as does
